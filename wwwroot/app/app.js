...
var app = angular.module('sureerp', ['ngRoute', 'LocalStorageModule', 'ui.tinymce', 'ngWebsocket']);
...
app.config(function ($routeProvider, $httpProvider, $controllerProvider, $compileProvider, $filterProvider, $provide, $locationProvider) {
    ...
    $routeProvider
        ...
        .when('/:module/:page/:action', {
            templateUrl: function (rd) {
                return '/app/' + rd.module + '/' + rd.page + '/' + rd.action + '.html';
            },
            resolve: {
                load: function ($q, $route, $rootScope) {
                    var deferred = $q.defer();
                    ...
                    var dependencies = [
                        '/app/' + params.module + '/' + params.page + '/translations/' + params.page + 'Translation_' + keyLang + '.js?v=' + version,
                        '/app/' + params.module + '/' + params.page + '/' + params.page + 'Setting.js?v=' + version,
                        '/app/' + params.module + '/' + params.page + '/' + params.page + 'Controller.js?v=' + version,
                    ];
        ...
        .when('/:module/:page', {
            templateUrl: function (rd) {
                return '/app/' + rd.module + '/' + rd.page + '/' + rd.page + '.html';
            },
            resolve: {
                load: function ($q, $route, $rootScope) {
                    var deferred = $q.defer();
        ...
        .when('/', {
            templateUrl: function (rd) {
                return '/app/system/dashboard/dashboard.html';
            },
            resolve: {
                load: function ($q, $route, $rootScope) {
                    var deferred = $q.defer();
                    ...
                    var dependencies = [
                        '/app/system/dashboard/dashboardSetting.js?v=' + version,
                        '/app/system/dashboard/dashboardController.js?v=' + version
                    ];
...
app.run(['$rootScope', '$templateCache', '$route', 'authService', function ($rootScope, $templateCache, $route, authService) {
    debugger;
