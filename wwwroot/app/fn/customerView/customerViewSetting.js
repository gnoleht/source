var customerViewSetting = null;
function customerViewInitSetting() {
    customerViewSetting = {
        view: {
            module: 'fn',
            formName: 'customerView',
            gridName: 'grvcustomerView',
            entityName: 'FN_customerView',
            ...
            grvDetail: {
                ...
                updateFooter: function (grid) {
                    ...
                    while (columnIdx--) {
                        ...
                        $(columnElement).html(customerView .TOTAL + ": " + total.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' VNĐ');
                    }
                },
            }
        },
