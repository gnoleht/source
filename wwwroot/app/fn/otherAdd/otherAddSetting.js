var otherAddSetting = null;
function otherAddInitSetting() {
    otherAddSetting = {
        view: {
            module: 'fn',
            formName: 'otherAdd',
            gridName: 'grvotherAdd',
            entityName: 'FN_otherAdd',
            ...
            grvDetail: {
                ...
                updateFooter: function (grid) {
                    ...
                    while (columnIdx--) {
                        ...
                        $(columnElement).html(otherAddTranslation .TOTAL + ": " + total.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' VNĐ');
                    }
                },
            }
        },
