var stateAgenciesAddSetting = null;
function stateAgenciesAddInitSetting() {
    stateAgenciesAddSetting = {
        view: {
            module: 'fn',
            formName: 'stateAgenciesAdd',
            gridName: 'grvstateAgenciesAdd',
            entityName: 'FN_stateAgenciesAdd',
            ...
            grvDetail: {
                ...
                updateFooter: function (grid) {
                    ...
                    while (columnIdx--) {
                        ...
                        $(columnElement).html(stateAgenciesAddTranslation .TOTAL + ": " + total.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' VNĐ');
                    }
                },
            }
        },
