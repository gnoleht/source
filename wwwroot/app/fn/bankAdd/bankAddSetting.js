var bankAddSetting = null;
function bankAddInitSetting() {
    bankAddSetting = {
        view: {
            module: 'fn',
            formName: 'bankAdd',
            gridName: 'grvbankAdd',
            entityName: 'FN_bankAdd',

            //title: bankTranslation.TITLE,
            //description: bankTranslation.NAME,
        },
            ...
            grvDetail: {
                ...
                updateFooter: function (grid) {
                    ...
                    while (columnIdx--) {
                        ...
                        $(columnElement).html(bankTranslation .TOTAL + ": " + total.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' VNĐ');
                    }
                },
            }
        },
