var customerAddSetting = null;
function customerAddInitSetting() {
    customerAddSetting = {
        view: {
            module: 'fn',
            formName: 'customerAdd',
            gridName: 'grvCustomerAdd',
            entityName: 'FN_CustomerAdd',

            //title: customerAddTranslation.TITLE,
            //description: customerAddTranslation.NAME,
        },
            ...
            grvDetail: {
                ...
                updateFooter: function (grid) {
                    ...
                    while (columnIdx--) {
                        ...
                        $(columnElement).html(customerAddTranslation .TOTAL + ": " + total.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' VNĐ');
                    }
                },
            }
        },
