'use strict';
app.register.controller('customerController', ['$scope', '$location', 'authService', function ($scope, $location, authService) {
    ...
    $scope.$on('$routeChangeSuccess', function () {
        ...
        $(window).resize(function () {
            ...
            var box_control = $("#customer .box_control").height();
            $("#customer .scroll").height(height - box_control - 20);
        });
        $(window).resize();
