            ...
            grvDetail: {
                ...
                updateFooter: function (grid) {
                    ...
                    while (columnIdx--) {
                        ...
                        $(columnElement).html(costTranslation .TOTAL + ": " + total.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) + ' VNĐ');
                    }
                },
            }
        },
