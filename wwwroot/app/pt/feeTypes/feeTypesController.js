'use strict';
app.register.controller('feeTypesController', ['$scope', '$timeout', function ($scope, $timeout) {
    //init
    ...
    $scope.loadData = function () {
        ...
        $scope.postData('api/pt/feeTypes/Get', params, function (data) {
            if (data) {
    ...
    $scope.deleteData = function () {
        ...
        $scope.postData("api/pt/feeTypes/Delete", params, function (data) {
            if (data) {
    ...
    $scope.save = function () {
        ...
        if ($scope.action === 'add') {
            $scope.postData("api/pt/feeTypes/Add", params, function (data) {
                if (data) {
            ...
            $scope.postData("api/pt/feeTypes/Update", params, function (data) {
                if (data) {
