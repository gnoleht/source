'use strict';
app.register.controller('roomLogisticsController', ['$scope', '$timeout', function ($scope, $timeout) {
    //init
    ...
    $scope.loadData = function () {
        ...
        $scope.postData('api/pt/roomLogistics/Get', params, function (data) {
            if (data) {
    ...
    $scope.deleteData = function () {
        ...
        $scope.postData("api/pt/roomLogistics/Delete", params, function (data) {
            if (data) {
    ...
    $scope.save = function () {
        ...
        if ($scope.action === 'add') {
            $scope.postData("api/pt/roomLogistics/Add", params, function (data) {
                if (data) {
            ...
            $scope.postData("api/pt/roomLogistics/Update", params, function (data) {
                if (data) {
