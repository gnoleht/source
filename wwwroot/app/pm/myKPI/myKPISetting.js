...
function myKPIInitSetting() {
    myKPISetting.grid = {
        url: 'api/pm/myKPI/get',
        defaultUrl: 'api/pm/myKPI/get',
        ...
        columns: [
            ...
            {
                id: "resourceName", field: "resourceName", name: myKPITranslation.RESOURCENAME, width: 860, minWidth: 200, sortable: false, dataType: 'text',
                formatter: function (row, cell, value, columnDef, dataContext) {
            ...
            {
                id: 'sumTaskNew', field: 'sumTaskNew', name: myKPITranslation.SUMTASKNEW, width: 52, filterable: false,
                formatter: function (row, cell, value, columnDef, dataContext) {
            ...
            {
                id: 'sumTaskActive', field: 'sumTaskActive', name: myKPITranslation.SUMTASKACTIVE, width: 67, filterable: false,
                formatter: function (row, cell, value, columnDef, dataContext) {
                    if (dataContext.indent != 2) {
                        return '<span class="center" style="display:block;">' + value + '</span>';
                    }
            ...
            {
                id: 'sumTaskClosed', field: 'sumTaskClosed', name: myKPITranslation.SUMTASKCLOSED, width: 67, filterable: false,
                formatter: function (row, cell, value, columnDef, dataContext) {
                    if (dataContext.indent != 2) {
                        return '<span class="center" style="display:block;">' + value + '</span>';
                    }
            ...
            {
                id: 'avgTaskCompleted', field: 'avgTaskCompleted', name: myKPITranslation.AVGTASKCOMPLETED, width: 83, filterable: false,
                formatter: function (row, cell, value, columnDef, dataContext) {
                    if (dataContext.indent != 2) {
            ...
            {
                id: 'originalEstimate', field: 'originalEstimate', name: myKPITranslation.ORIGINALESTIMATE, width: 83, filterable: false,
                formatter: function (row, cell, value, columnDef, dataContext) {
                    return '<span class="center" style="display:block;">' + Math.round(value * 100) / 100 + '</span>';
                }
            },
            {
                id: 'remaining', field: 'remaining', name: myKPITranslation.REMAINING_WORK, width: 94, filterable: false,
                formatter: function (row, cell, value, columnDef, dataContext) {
                    return '<span class="center" style="display:block;">' + Math.round(value * 100) / 100 + '</span>';
                }
            },
            {
                id: 'completed', field: 'completed', name: myKPITranslation.COMPLETED_WORK, width: 93, filterable: false,
                formatter: function (row, cell, value, columnDef, dataContext) {
                    return '<span class="center" style="display:block;">' + Math.round(value * 100) / 100 + '</span>';
                }
            },
            {
                id: 'efforfCompleted', field: 'efforfCompleted', name: myKPITranslation.EFFORFCOMPLETED, width: 83, filterable: false,
                formatter: function (row, cell, value, columnDef, dataContext) {
                    if (dataContext.indent != 2) {
                        return '<span class="center" style="display:block;">' + Math.round(value * 100) / 100 + "%" + '</span>';
                    }
            ...
            {
                id: 'kpi', field: 'kpi', name: myKPITranslation.KPI, width: 74, filterable: false,
                formatter: function (row, cell, value, columnDef, dataContext) {
                    if (dataContext.indent != 2) {
                        return '<span class="center" style="display:block;">' + Math.round(value * 100) / 100 + "%" + '</span>';
                    }
        ...
        updateFooter: function (grid) {
            ...
            var columnElement = grid.getFooterRowColumn("resourceName");
            $(columnElement).html("<div class='text-right'>" + myKPITranslation.TOTAL + ": </div>")
