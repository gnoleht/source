...
window.SAVE_URL = window.SAVE_URL || '/api/WorkItem/SaveUseCase?refId=' + window.urlParams["refId"];
window.OPEN_URL = window.OPEN_URL || '/api/WorkItem/GetUseCase?refId=' + window.urlParams["refId"];
