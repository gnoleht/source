'use strict';
app.register.controller('reportCashierController', ['$scope', '$timeout', function ($scope, $timeout) {
    $scope.$on('$routeChangeSuccess', function () {
        $.ajax({
            ...
            success: function (data) {
                ...
                $scope.setting.valuelist.group = $scope.setting.valuelist.group.filter(x => x.id != 5);
            }
        });
        //$scope.loadItem();
        //$scope.reloadGrid();
    ...
    $scope.loadData = function () {
        ...
        $scope.postData("api/pos/reportCashier/get", params, function (data) {
            //debugger
            if (data) {
                //debugger
